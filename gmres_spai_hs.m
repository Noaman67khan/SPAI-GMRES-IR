function [x, error, its, flag] = gmres_spai_hs( A, x, b, M, restrt, max_it, tol)
%GMRES_SPAI_HS   Left-preconditioned GMRES in half/single precision
